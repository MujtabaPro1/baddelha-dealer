...
const CarBodySvgView: React.FC<CarBodySvgProps> = ({
  ...
  return (
    ...
    <path id="rear_left_wing" className={getPartColor('c_n_wing_rear_left')} 
    ...
    <path id="front_left_door" className={getPartColor('c_n_door_front_left')} 
    ...
    <path id="rear_left_door" className={getPartColor('c_n_door_rear_left')} 
    ...
    <path id="front_left_wing" className={getPartColor('c_n_wing_front_left')} 
    ...
    <path id="trunk" className={getPartColor('c_n_boot')} 
    ...
    <path id="windscreen" className={getPartColor('c_n_windscreen')} 
    ...
    <path id="rear_screen" className={getPartColor('c_n_rear_screen')} 
    ...
    <path id="front_bumper" className={getPartColor('c_n_bumper_front')} 
    ...
    <path id="rear_bumper_1_" className={getPartColor('c_n_bumber_rear')} 
    ...
    <path id="bonnet" className={getPartColor('c_n_bonnet')} 
    ...
    <path id="roof" className={getPartColor('c_n_roof')} 
    ...
    <path id="front_left_window" className={getPartColor('c_n_front_left_window')} 
    ...
    <path id="rear_right_wing" className={getPartColor('c_n_wing_rear_right')} 
    ...
    <path id="front_right_door" className={getPartColor('c_n_door_front_right')} 
    ...
    <path id="rear_right_door" className={getPartColor('c_n_door_rear_right')} 
    ...
    <path id="front_right_wing" className={getPartColor('c_n_wing_front_right')} 
    ...
    <path id="front_right_window" className={getPartColor('c_n_front_right_window')} 
    ...
    <path id="rear_left_window" className={getPartColor('c_n_rear_left_window')} 
    ...
    <path id="rear_right_window" className={getPartColor('c_n_rear_right_window')} 
    ...
    <path id="sunroof" className={getPartColor('c_sunroof_moonroof')} 
