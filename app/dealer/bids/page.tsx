    ...
    <Card className="overflow-hidden hover:shadow-md transition-all duration-300">
      <div className="flex flex-col md:flex-row">
        <div className="md:w-1/4">
          <img
            src={bid.carDetails?.image || 'https://cau-stg-bucket.s3.af-south-1.amazonaws.com/Inspection/file-1756034889879-447329168?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=AKIAQ3EGRILCC65ZXTFT%2F20250910%2Faf-south-1%2Fs3%2Faws4_request&X-Amz-Date=20250910T145624Z&X-Amz-Expires=86400&X-Amz-Signature=da1d52f21c8d1838920f1737b38976f8fd5868378680901c0d62fb51a382cf4d&X-Amz-SignedHeaders=host'}
